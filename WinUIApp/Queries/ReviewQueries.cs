...
namespace WinUIApp.Queries
{
    ...
    public static class ReviewQueries
    {
        ...
        /// </summary>
        public const string DeleteReviewByIdQuery = "DELETE FROM Review WHERE ReviewId = @ReviewId";

        /// <summary>
        /// The query to retrieve all reviews.
        /// </summary>
        public const string GetAllReviewsQuery = "SELECT * FROM Review";

        /// <summary>
        /// The query to retrieve a review by its unique identifier.
        /// </summary>
        public const string GetReviewByIdQuery = "SELECT * FROM Review WHERE ReviewId = @ReviewId";

        /// <summary>
        /// The query to retrieve reviews associated with a specific rating identifier.
        /// </summary>
        public const string GetReviewsByRatingIdQuery = "SELECT * FROM Review WHERE RatingId = @RatingId";

        /// <summary>
        /// The query to insert a new review into the database.
        /// </summary>
        public const string AddReviewQuery =
            @"INSERT INTO Review (RatingId, UserId, Content, CreationDate, IsActive)
