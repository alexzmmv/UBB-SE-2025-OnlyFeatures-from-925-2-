...
namespace WinUIApp.Queries
{
    ...
    public static class RatingQueries
    {
        ...
        /// </summary>
        public const string GetAllRatingsQuery = "SELECT * FROM Rating";

        /// <summary>
        /// The query to retrieve a rating by its unique identifier.
        /// </summary>
        public const string GetRatingByIdQuery = "SELECT * FROM Rating WHERE RatingId = @RatingId";

        /// <summary>
        /// The query to retrieve ratings by product identifier.
        /// </summary>
        public const string GetRatingsByProductIdQuery = "SELECT * FROM Rating WHERE ProductId = @ProductId";

        /// <summary>
        /// The query to insert a new rating into the database.
        /// </summary>
        public const string AddRatingQuery =
            @"INSERT INTO Rating (ProductId, UserId, RatingValue, RatingDate, IsActive)
        ...
        /// </summary>
        public const string DeleteRatingQuery = "DELETE FROM Rating WHERE RatingId = @RatingId";
        ...
        /// </summary>
        public const string GetAverageRatingQuery = "SELECT AVG(RatingValue) FROM Rating WHERE ProductId = @ProductId";

        /// <summary>
        /// The query to get the total number of ratings for a product.
        /// </summary>
        public const string GetRatingCountQuery = "SELECT COUNT(*) FROM Rating WHERE ProductId = @ProductId";
    }
}
